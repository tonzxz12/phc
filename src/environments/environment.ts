  ...
  appTitle: 'PHC LMS',
  appShortTitle: 'PHC LMS',
  appPhrase:' Empowering Learning Through Innovative Online Learning ',
  welcomeText: 'Stay Active and Engaged Learn New Things Online',
  // appLogo:'assets/login/ustl.png',
  appLogo:'assets/login/phc.png',
  light:{
    50: '#ffffff',    
    100: '#f8f8f8',   
    200: '#e5e5e5',  
